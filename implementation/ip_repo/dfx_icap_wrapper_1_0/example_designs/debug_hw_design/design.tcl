...
proc create_ipi_design { offsetfile design_name } {
	...
	# Create instance: dfx_icap_wrapper_0, and set properties
	set dfx_icap_wrapper_0 [ create_bd_cell -type ip -vlnv user.org:user:dfx_icap_wrapper:1.0 dfx_icap_wrapper_0 ]
	...
	# Connect all clock & reset of dfx_icap_wrapper_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins dfx_icap_wrapper_0/s_axi_reg]
	connect_bd_net [get_bd_pins dfx_icap_wrapper_0/s_axi_reg_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins dfx_icap_wrapper_0/s_axi_reg_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]

	# Connect all clock, reset & status pins of dfx_icap_wrapper_0 master interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S00_AXI] [get_bd_intf_pins dfx_icap_wrapper_0/M_AXI_MEM]
	connect_bd_net [get_bd_pins dfx_icap_wrapper_0/m_axi_mem_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins dfx_icap_wrapper_0/m_axi_mem_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins dfx_icap_wrapper_0/m_axi_mem_txn_done] [get_bd_pins xlconcat_0/In0]
	connect_bd_net [get_bd_pins dfx_icap_wrapper_0/m_axi_mem_error] [get_bd_pins xlconcat_0/In1]
	connect_bd_net [get_bd_pins dfx_icap_wrapper_0/m_axi_mem_init_axi_txn] [ get_bd_pins axi_gpio_out/gpio_io_o ]


	# Auto assign address
	assign_bd_address

	# Configure address param & range of dfx_icap_wrapper_0 master interfaces..
	set_property range 16K [get_bd_addr_segs {jtag_axi_0/Data/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {dfx_icap_wrapper_0/M_AXI_MEM/SEG_axi_bram_ctrl_0_Mem0}]
	set_property -dict [list  CONFIG.C_M_AXI_MEM_TARGET_SLAVE_BASE_ADDR {0xC0000000} ] [get_bd_cells dfx_icap_wrapper_0]

	# Copy all address to dfx_icap_wrapper_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/dfx_icap_wrapper_v1_0_include.tcl"
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_dfx_icap_wrapper_0_s_axi_reg_* ]]
	puts $fp "set s_axi_reg_addr ${offset}"

	close $fp
}

# Set IP Repository and Update IP Catalogue 
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:dfx_icap_wrapper:1.0]]]]
set hw_test_file ${ip_path}/example_designs/debug_hw_design/dfx_icap_wrapper_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "dfx_icap_wrapper_v1_0_hw_${i}"
